...
class TestSubtaskWithTimingColumnsManagerQuerySet(object):
    ...
    def test_that_subtask_verification_time_query_gives_correct_value(
        ...
        with override_settings(
            ...
            assert_that(
                Subtask.objects_with_timing_columns.get(subtask_id=self.report_computed_task.task_to_compute.subtask_id)
        ...
        with override_settings(
            ...
            assert_that(
                Subtask.objects_with_timing_columns.get(
                    subtask_id=self.report_computed_task.task_to_compute.subtask_id).maximum_download_time).is_equal_to(
    ...
    def test_that_download_deadline_query_gives_correct_value(
        ...
        with override_settings(
            ...
            assert_that(
                Subtask.objects_with_timing_columns.get(
                    subtask_id=self.report_computed_task.task_to_compute.subtask_id).download_deadline).is_equal_to(
                (Subtask.objects_with_timing_columns.get(
                    subtask_id=self.report_computed_task.task_to_compute.subtask_id).computation_deadline.timestamp() +
                Subtask.objects_with_timing_columns.get(
                    subtask_id=self.report_computed_task.task_to_compute.subtask_id).subtask_verification_time),
            )
